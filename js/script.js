(function($) {
    ...
    //News Toggle Link / News Section Home Page One
    if($('.news-section .news-option .option-inner').length){
        $(".news-section .news-option .option-inner").on('click', function() {
            $(this).toggleClass('active');
            $('.news-section .news-inner-container').toggleClass('active-news');
        });
    }
